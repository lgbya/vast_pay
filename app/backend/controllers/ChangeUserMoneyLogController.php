...
class ChangeUserMoneyLogController extends Controller
{
    ...
    /**
     * Displays a single ChangeUserMoneyLog model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new ChangeUserMoneyLog model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ChangeUserMoneyLog();
    ...
    /**
     * Updates an existing ChangeUserMoneyLog model.
    ...
    /**
     * Deletes an existing ChangeUserMoneyLog model.
    ...
    /**
     * Finds the ChangeUserMoneyLog model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ChangeUserMoneyLog the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
